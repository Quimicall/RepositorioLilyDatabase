    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('afinidade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='afinidade2', to='contas.categoria')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categoria2', to='contas.categoria')),
                ('exp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exp2', to='contas.categoria')),
                ...
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='level2', to='contas.categoria')),
